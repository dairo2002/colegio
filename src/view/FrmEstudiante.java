...
public class FrmEstudiante extends javax.swing.JFrame {
     ...
     */
    public estudianteController estudiante = new estudianteController();
    ...
    private void tblaEstudianteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblaEstudianteMouseClicked
         ...
         *
         * @listarEstudiante: Treamos la lista<Estudiante>
         * @estudiante: es el objecto de la instancia del contoller estudiante
         * @listaEstudiante: es el metodo del que esta en controlador estudiante
         * y trae los datos almacenados en la lista.
         *
         ...
         * el id. Los otros campos, con los setText se mostraran los datos.
         */
        listarEstudiante = estudiante.listaEstudiante();
        idEstudiante = listarEstudiante.get(seleccionar).getId();
